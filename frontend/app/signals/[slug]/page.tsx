                ...
                <div className="flex gap-3 px-5 py-3">
                  ...
                  <div>
                    ...
                    <span className="text-zinc-600">
                      Enter long zone {fmt(signal.close)} · Stop {fmt(signal.sl)} · Target {fmt(signal.tp)}
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🟢</span>
                  <div>
                    <span className="font-semibold">Long ต้นทุนต่ำ:</span>{" "}
                    <span className="text-zinc-600">
                      Hold · trail stop up · target {fmt(signal.tp)}
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🔴</span>
                  <div>
                    <span className="font-semibold">Long ต้นทุนสูง:</span>{" "}
                    <span className="text-zinc-600">
                      ระวัง — set hard stop {fmt(signal.sl)} immediately if unset
                    </span>
                  </div>
                </div>
              </>
              ...
              <>
                <div className="flex gap-3 px-5 py-3">
                  ...
                  <div>
                    <span className="font-semibold">Flat:</span>{" "}
                    <span className="text-zinc-600">
                      Enter short zone {fmt(signal.close)} · Stop {fmt(signal.sl)} · Target {fmt(signal.tp)}
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🔴</span>
                  <div>
                    <span className="font-semibold">Short ต้นทุนดี:</span>{" "}
                    <span className="text-zinc-600">Hold · trail stop down · target {fmt(signal.tp)}</span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🟢</span>
                  <div>
                    ...
                    <span className="text-zinc-600">
                      Bearish signal active — review stop, consider partial exit
                    </span>
                  </div>
                </div>
              </>
              ...
              <>
                <div className="flex gap-3 px-5 py-3">
                  ...
                  <div>
                    <span className="font-semibold">Flat:</span>{" "}
                    <span className="text-zinc-600">
                      ยังไม่เข้า — รอ trigger ที่ชัดกว่านี้ก่อน · set alert ที่ {fmt(signal.close)}
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  ...
                  <div>
                    <span className="font-semibold">Long ต้นทุนต่ำ:</span>{" "}
                    <span className="text-zinc-600">
                      Hold · trend still intact · stop {fmt(signal.sl)}
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🟡</span>
                  <div>
                    <span className="font-semibold">Long ต้นทุนกลาง:</span>{" "}
                    <span className="text-zinc-600">
                      Hold with caution · tighten stop if price weakens
                    </span>
                  </div>
                </div>
              </>
              ...
              <>
                <div className="flex gap-3 px-5 py-3">
                  ...
                  <div>
                    <span className="font-semibold">Flat:</span>{" "}
                    <span className="text-zinc-600">
                      Stay flat — regime mixed or range-bound · no edge here
                    </span>
                  </div>
                </div>
                <div className="flex gap-3 px-5 py-3">
                  <span className="text-base">🟡</span>
                  <div>
                    <span className="font-semibold">Any position:</span>{" "}
                    <span className="text-zinc-600">
                      Review your stop — no directional edge confirmed
                    </span>
                  </div>
                </div>
              </>
